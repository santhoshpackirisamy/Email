...
public class database 
{
	...
	public static void deletemsg(String id)
	{
		try
		{  
			stmt.executeUpdate("UPDATE MESSAGE set deletestatus=1 where ID=" +id+ ";");  
		}
		catch(Exception e){System.out.println(e);}  
	}
	...
	{
		ResultSet rs = stmt.executeQuery("SELECT * FROM MESSAGE WHERE receivedby ='" +name+ "' AND deletestatus=1AND trashbin=0 ORDER BY id DESC;");
	...
	public static void deletetrash(String id)
	{
		try
		{  
			stmt.executeUpdate("UPDATE MESSAGE set trashbin=1 where ID=" +id+ ";");  
		}
		catch(Exception e){System.out.println(e);}  
	}
	
	public static void deletealltrash(int id)
	{
		try
		{  
			stmt.executeUpdate("UPDATE MESSAGE set deletestatus=1,checkbox=1,trashbin=1 where ID=" +id+ ";");
		}
		catch(Exception e){System.out.println(e);}  
	}
